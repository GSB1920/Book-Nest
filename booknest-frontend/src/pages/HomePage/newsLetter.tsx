...
const NewsLetter = () => {
  return (
    <div className="w-full p-14 layout_padding g bg-gradient-to-r from-black via-gray-900 to-black">
      <div className="container mx-auto flex-col space-y-10">
        <h1 className="text-center text-bold text-4xl text-white uppercase">
